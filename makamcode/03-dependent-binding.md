...
The type system of λProlog can be viewed as a particular subset of System F$_ω$: namely, it is the
...
type-in-type, this subset of System F$_ω$ is enough to model some form of dependency. For example, we
