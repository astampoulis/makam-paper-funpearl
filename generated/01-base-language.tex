...
\heroADVISOR{} Well you were missing the occurs-check. \lamprolog unification
includes it:
...
\heroADVISOR{} Sure, \lamprolog has polymorphic types and higher-order
predicates:
...
\heroSTUDENT{} Nice! I guess that's why you wanted to go with \lamprolog for
