...
\texttt{F\ X}, as we have been doing so far. In this case, we will later
on have variables that stand for open STLC terms, and there will be some
extra computation involved, so the normal application won't work as is.
