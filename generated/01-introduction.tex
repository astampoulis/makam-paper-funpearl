...
\heroSTUDENT{} Oh, so you mean \foreignlanguage{greek}{λ}Prolog \citep{lambdaprolog-main-reference} or
LF \citep{lf-main-reference}.
...
of languages. It's called Makam. It should be able to handle our
MetaML-like language nicely, and we should not need to spend more than a
few hours on it!
...
fun. I'll tell you all the details along the way too -- I know how you
always want to understand things in depth!
