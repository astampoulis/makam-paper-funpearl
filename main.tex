...
\title{Rapid Prototyping of Language Implementations via Higher-Order Logic Programming with Makam}
...
\input{generated/01-base-language}

\section{Multiple binding}
\input{generated/02-binding-forms}

\section{Dependent binding}
\input{generated/03-dependent-binding}

\section{More ML-like language}
\input{generated/04-ml-subset}

\section{Adding Type Synonyms}
\input{generated/05-type-synonyms}

\section{Contextual Types}
\input{generated/06-veriml-light}

\section{Hindley-Milner Polymorphism}
\input{generated/07-hindley-milner}
