\section{Where the legend of the GADTs is
recounted}\label{where-the-legend-of-the-gadts-is-recounted}

\it

Once upon a time, the great republic of Haskell lacked one of the
natural wonders that it is now well-known for, and which is now
regularly visited by tourists and inhabitants alike. I am talking of
course about the Great Arboretum of Dangling Trees, known as GADTs for
short.

Then settlers from the far-away land of the Dependency started coming to
the republic, and were speaking of lists that knew their length, of
...
republic, namely the GADTs that we know and love, to remind them of home
a little. And they maintained all the careful balances that were needed
with the other ecosystems of the republic, like the Type Inference, and
the Coverage Checker, and the Constructs of the Core Calculus, and so
on.
...
anonymity and might remain so for all time. They went something like
this.
...
sort of propositions is a bit special, since its terms represent
computations too, but otherwise it is just a normal type.
