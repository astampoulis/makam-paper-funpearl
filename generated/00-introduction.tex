...
\heroADVISOR{} Yes, all of those should be good choices. I was actually
thinking though that we should use higher-order logic
programming\ldots{} it's a formalism that is well-suited to what we want
to do, since we will need all sorts of different binding constructs, and
the type system we are thinking about is quite advanced.
