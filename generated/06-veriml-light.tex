...
that they're a different type. And we might need to check that are
well-formed.
...
I also see that your structural recursion just needs to do a simple
visit, it does not need to produce an output; hence the repeat of the
same \texttt{typ} argument. Let's prepare for substitutions too, in the
same way.
...
\heroSTUDENT{} They might be the ghosts of people who left academia for
industry.
